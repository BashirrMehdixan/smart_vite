        ...
        <>
            <div className="container">
                <div className="flex flex-wrap">
                    <div
                        className="w-full flex flex-wrap justify-between font-semibold text-main-blue space-x-2 pt-3 pb-20 sorting-box">
                        <button type="button"
                                className="w-full md:w-card-width-md lg:w-card-width-lg mb-3 border border-main-blue py-3 rounded-2xl hover:bg-main-blue hover:text-white duration-500 btn-sort">
                            Yeni məhsullar
                        </button>
                        <button type="button"
                                className="w-full md:w-card-width-md lg:w-card-width-lg mb-3 border border-main-blue py-3 rounded-2xl hover:bg-main-blue hover:text-white duration-500 btn-sort">
